...
void Usage(char *program) {
    ...
    printf("  --sr_maxfactor/-m            Maximum value of the factor to apply strength reduction.\n");
}
...
static int ProcessArgs(int argc, char *argv[])
{
  static struct option long_options[] = {
        ...
        {"sr_maxfactor", required_argument, 0, 'm'},
        {0, 0, 0, 0}};
  ...
  while (1) {
      ...
      case 'o':
        ...
        break;
      case 'm':
        global.strength_reduction_max_factor = (int) strtol(optarg, NULL, 10);
        break;
      case 'h':
        Usage(argv[0]);
        exit(EXIT_SUCCESS);
